    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-3">
            <div class="col-md-12 profile-data">
                ...
                <h5 class="profile-jobtitle">{{ $user->jobtitle }}</h5>
                <p class="profile-about"><span class="font-weight-bold">About: </span>{{ $user->about }}</p>
                <p class="profile-email"><span class="font-weight-bold">Email: </span>{{ $user->email }}</p>
                <p class="profile-phone"><span class="font-weight-bold">Phone: </span>{{ $user->phone }}</p>
            </div>
        </div>

        <div class="col-md-9 profile-resume">
            <h3 class="resume-header">{{ $user->firstname . ' ' . $user->lastname . ', ' . $user->jobtitle  }}</h3>
